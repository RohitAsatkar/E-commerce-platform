...
('m1', 'Minimalist Leather Jacket', 450, 'overshirts', true, 'https://images.unsplash.com/photo-1551028719-00167b16eac5?auto=format&fit=crop&q=80&w=800', 'A premium minimalist black leather jacket, tailored for a perfect fit.'),
('m2', 'Cashmere Blend Overcoat', 580, 'overshirts', false, 'https://images.unsplash.com/photo-1512436991641-6745cdb1723f?auto=format&fit=crop&q=80&w=800', 'Luxurious cashmere blend overcoat.'),
('m3', 'Essential Cotton Tee', 65, 't-shirts', true, 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&q=80&w=800', 'Premium heavyweight cotton tee with a relaxed fit.'),
('m4', 'Tailored Cargo Pants', 120, 'cargo-pants', false, 'https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?auto=format&fit=crop&q=80&w=800', 'Classic tailored cargo pants in a versatile khaki shade.'),
('m5', 'Oxford Cloth Button-Down', 85, 'shirts', true, 'https://images.unsplash.com/photo-1596755094514-f87e34085b2c?auto=format&fit=crop&q=80&w=800', 'The quintessential white oxford shirt, perfect for layering.'),
('m6', 'Linen Vacation Shirt', 140, 'linen', false, 'https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?auto=format&fit=crop&q=80&w=800', 'Soft and breathable premium linen resort collar shirt.'),
('m7', 'Denim Trucker Jacket', 195, 'overshirts', false, 'https://images.unsplash.com/photo-1495105787522-5334e3ffa0ef?auto=format&fit=crop&q=80&w=800', 'Vintage-washed denim jacket with a modern cut.'),
('m8', 'Premium Knit Joggers', 160, 'joggers', true, 'https://images.unsplash.com/photo-1506629082955-511b1aa562c8?auto=format&fit=crop&q=80&w=800', 'Sharp, tailored knit joggers for elevated loungewear.'),
('m9', 'Classic Polo Shirt', 75, 'polo', false, 'https://images.unsplash.com/photo-1586363104862-3a5e2ab60d99?auto=format&fit=crop&q=80&w=800', 'Breathable pique cotton polo shirt.'),
('m10', 'Lightweight Bomber Jacket', 220, 'overshirts', true, 'https://images.unsplash.com/photo-1591047139829-d91aecb6caea?auto=format&fit=crop&q=80&w=800', 'Minimalist water-resistant bomber jacket.'),
('m11', 'Corduroy Overshirt', 110, 'overshirts', false, 'https://images.unsplash.com/photo-1590330297626-d7aff25a0431?auto=format&fit=crop&q=80&w=800', 'Heavyweight corduroy overshirt for transitional weather.'),
...
('a6', 'Suede Chelsea Boots', 310, 'footwear', false, 'https://images.unsplash.com/photo-1638247025967-b4e38f787b76?auto=format&fit=crop&q=80&w=800', 'Classic suede Chelsea boots.'),
